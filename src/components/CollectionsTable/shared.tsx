...
const CollectionHeader: React.FC<TextProps> = (props) => <Text textStyle="detail" color="text-02" {...props} />;
...
export const AmountVolumeDisplay = ({ amount, change, ...props }: AmountVolumeDisplayProps) => (
