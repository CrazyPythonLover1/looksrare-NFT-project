...
import { ChevronUp, ChevronDown, Text } from "uikit";
import { DEFAULT_TRANSITION_DUR, SIDEBAR_WIDTH_COLLAPSED, SIDEBAR_WIDTH_OPEN } from "components/Layout/FilterLayout";
...
export const PropertyGroupHeader = ({
  ...
  const getRightIcon = () => {
    ...
    return isOpen ? <ChevronUp boxSize={5} color="text-03" /> : <ChevronDown boxSize={5} color="text-03" />;
  };
