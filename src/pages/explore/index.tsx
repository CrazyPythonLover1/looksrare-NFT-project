...
import { currentChainInfo, TOKENS_PER_PAGE } from "config";
import { headers } from "config/server";
import { getCollectionsFilters, getTokens } from "utils/graphql";
...
import { getTokenFilterQuery } from "components/Filters";
